...
const shoes = [
    {id:0,name:"Fall Limited Edition Sneakers",price:prices[0].toFixed(2), image:"https://i.ibb.co/PGB5ywS/image-product-1.jpg",description:"These low-profile sneakers are your perfect casual wear companion. Featuring a durable rubber outer sole, they'll withstand everything the weather can offer.",porcent:prices[1],endprice:prices[2].toFixed(2),company:"SNEAKER COMPANY",
